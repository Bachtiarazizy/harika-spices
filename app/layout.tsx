...
export const metadata: Metadata = {
  title: {
    default: "Premium Indonesian Spices Exporter & Supplier | Harika Spices",
  ...
  keywords: [
    ...
    "Bulk spices Indonesia",
    "contact Indonesian spices exporter",
    "Indonesian spices supplier inquiry",
    "Indonesian spices exporter company",
    "spices export from Indonesia",
    "bulk Indonesian spices supplier",
    "spices supplier Indonesia",
    "Indonesian spice products",
    "sustainable spice sourcing Indonesia",
    "Export quality spices Indonesiar",
    "export quality Indonesian spices",
  ],
  ...
  openGraph: {
    ...
    title: "Harika Spices - Premium Indonesian Spice Exporter & Supplier",
    description: "Harika Spices is a premium Indonesian spices exporter and supplier, providing export‑quality spices sourced ethically from Indonesia. Trusted global supply.",
    images: [
      {
        url: "/og-image.jpg",
